...
const COURSES: ICoursesProps[] = [
  ...
  },
  {
    id: uuidv4(),
    name: "HTML Academy",
    course: "Cкоринг технических навыков",
    image: "/courses/htmlacademy.jpg",
    http: "https://htmlacademy.ru/membrana-results/1915851-1-899a8f16",
    desc: "Скоринг навыков проводился в формате выполнения тестового задания с автоматическими проверками. В качестве заданий использовались задания легкого и среднего уровня сложности олимипиады по фронтенду для Яндекса.",
    language: "ru",
    date: "march 2024",
  },
];
